...
import cn.distance.ui.BackGroundRenderer;
import cn.distance.ui.buttons.UIFlatButton;
...
import cn.distance.util.render.Blur;
...
public class GuiLogin extends GuiScreen {
	...
	public static cn.core.auth.TextField username;
...
//						new Thread(() -> IRC.Verify(usernames, passwords)).start();
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		FontLoaders.GoogleSans16.drawString(Client.name + " made by \u00a7oTIQS\u00a7r (Distance Team)", width -
						FontLoaders.GoogleSans16.getStringWidth(Client.name+" made by \u00a7oTIQS\u00a7r (Distance Team)") - 1,
				...
				if (animIntro1 != 1) {
					...
					if (timerUtil.hasReached(1100)) {
						...
						if ((animIntro6 != 0 || animIntro7 != 0) && animIntro8 >= 1) {
							...
							FontLoaders.calibrilite35.drawCenteredString(Client.version, ((w / 2f + FontLoaders.calibrilite35.getStringWidth(Client.name)) - 10) + 0.7f, (((h / 2f) + 1) - (FontLoaders.calibrilite50.getHeight() / 2f)) + 0.7f, new Color(0, 0, 0, Math.max(Math.min((int) animIntro8,100),1)).getRGB());
							...
							FontLoaders.calibrilite35.drawCenteredString(Client.version, (w / 2f + FontLoaders.calibrilite35.getStringWidth(Client.name)) - 10, ((h / 2f) + 1) - (FontLoaders.calibrilite50.getHeight() / 2f), new Color(255, 255, 255, (int) animIntro8).getRGB());
