...
public class GuiNeedBlur extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontLoaders.GoogleSans16.drawCenteredString(Client.name+" made by \u00a7oTIQS\u00a7r & \u00a7oFunkNight\u00a7r (Distance Team)", width / 2f, height - FontLoaders.GoogleSans16.getHeight() - 6f, -1);
