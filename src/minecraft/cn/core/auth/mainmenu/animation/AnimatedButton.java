package cn.core.auth.mainmenu.animation;
...
public class AnimatedButton {
    ...
    public void updateAndDraw(int mouseX, int mouseY) {
        if (isIntroPlayed) {
            ...
            if (hoverAnim2 > 5) {
                FontLoaders.NovICON28.drawString(icons, (float) (posX) - 10f - (icons.equals("A") ? 10 : 0), (float) posY - 4, new Color(190, 190, 190, Math.max((int) hoverAnim2,0)).getRGB());
            }
