...
import cn.distance.util.misc.liquidbounce.LiquidRender;
import cn.distance.util.render.ETBRenderUtil;
...
extends Module {
    ...
    public static boolean qualifiesESP(Entity e2) {
        if(e2 == mc.thePlayer) {
            return false;
        }else if (e2.equals( KillAura.currentTarget) &&((KillAura) ModuleManager.getModuleByClass(KillAura.class)).esp.getValue()) {
            return false;
