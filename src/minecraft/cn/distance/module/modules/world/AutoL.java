...
import cn.distance.util.world.SpammerUtils;
...
extends Module {
	...
	private static String getTail(){
		return (ad.getValue()?" | get Distance -> Distance dot icu " : "") + (randomString.getValue() ? RandomUtil.randomString(5 + new Random().nextInt(5)):"");
	}
