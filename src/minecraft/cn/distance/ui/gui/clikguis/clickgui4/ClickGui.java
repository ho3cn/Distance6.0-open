package cn.distance.ui.gui.clikguis.clickgui4;
...
public class ClickGui extends GuiScreen implements GuiYesNoCallback {
	...
	private final int ClientColors = cn.distance.module.modules.render.ClickGui.CustomColor.getValue()? Client.getClientColor() : Client.getBBlueColor();
