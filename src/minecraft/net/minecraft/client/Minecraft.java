...
import cn.distance.api.EventBus;
import cn.distance.api.events.Misc.EventKey;
...
import cn.core.auth.mainmenu.GuiMainMenu;
import cn.core.auth.GuiNeedBlur;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        try {
            System.out.println("////////Distance is Start Load ViaVersion////////////");
            System.out.println("Distance正在加载跨版本模块可能会导致一些bug");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Minecraft 1.8.9 | Distance");
    ...
    public void drawSplashScreen(int much) {
        ...
        GlStateManager.alphaFunc(516, 0.1F);
        much = much / 10;
        Display.setTitle("Minecraft 1.8.9 | Distance !正在加载，很快就好 " + much + "/6");
        this.updateDisplay();
    }
